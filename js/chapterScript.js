...
const banglaMotivationalQuotes = [
  {
    quote: "``শিক্ষা এমন এক অস্ত্র, যা দিয়ে তুমি পৃথিবীকে পরিবর্তন করতে পারো।",
    author: "নেলসন ম্যান্ডেলা",
  },
  {
    quote: "``পরিশ্রম প্রতিভাকে হার মানায়, যদি প্রতিভা পরিশ্রম না করে।",
    author: "টিম নটকে",
  },
  { quote: "``জ্ঞানই শক্তি।", author: "ফ্রান্সিস বেকন" },
  {
    quote: "``যে কখনো হাল ছাড়ে না, তাকেই পরাজিত করা যায় না।",
    author: "নেপোলিয়ন হিল",
  },
  {
    quote: "``যদি তুমি স্বপ্ন দেখতে পারো, তবে তা পূরণও করতে পারবে।",
    author: "ওয়াল্ট ডিজনি",
  },
  {
    quote:
      "``সাফল্য হলো ছোট ছোট প্রচেষ্টার যোগফল, যা প্রতিদিন পুনরাবৃত্তি হয়।",
    author: "রবার্ট কলিয়ার",
  },
  { quote: "``তুমি যতই জানো না কেন, শেখার শেষ নেই।", author: "সক্রেটিস" },
  {
    quote: "``অধ্যবসায় ছাড়া কখনোই মহৎ কিছু অর্জন করা যায় না।",
    author: "স্যামুয়েল জনসন",
  },
  {
    quote:
      "``ভয় পেয়ো না, চেষ্টা করো। চেষ্টা করতে থাকলে ব্যর্থতাও তোমাকে শিক্ষা দেবে।",
    author: "অজ্ঞাত",
  },
  {
    quote: "``যে নিজেকে বিশ্বাস করে, তার জন্য অসম্ভব কিছুই নেই।",
    author: "মুহাম্মদ আলী",
  },
  { quote: "``আজকের কষ্টই আগামীকালের শক্তি।", author: "অজ্ঞাত" },
  {
    quote: "``শেখা কখনো থেমে থাকে না, এটা জীবনভর চলতে থাকে।",
    author: "হেনরি ফোর্ড",
  },
  {
    quote: "``সাহস হলো ভয়ের অনুপস্থিতি নয়, বরং ভয়কে জয় করা।",
    author: "নেলসন ম্যান্ডেলা",
  },
  { quote: "``ব্যর্থতা হলো সাফল্যের প্রথম ধাপ।", author: "থমাস এডিসন" },
  {
    quote: "``সময়কে কাজে লাগাতে শিখো, সময়ই সবচেয়ে বড় সম্পদ।",
    author: "বেনজামিন ফ্র্যাঙ্কলিন",
  },
  {
    quote: "``তুমি যা হতে চাও, আজ থেকেই সেই পথে হাঁটা শুরু করো।",
    author: "অজ্ঞাত",
  },
  {
    quote: "``সাফল্য আসে তাদের কাছেই যারা সুযোগকে কাজে লাগায়।",
    author: "অজ্ঞাত",
  },
  {
    quote: "``জ্ঞান অর্জনের শুরু হয় কৌতূহল থেকে।",
    author: "অ্যালবার্ট আইনস্টাইন",
  },
  {
    quote: "``তুমি চেষ্টা করতে থাকো, হাল ছেড়ো না— একদিন গন্তব্যে পৌঁছবেই।",
    author: "অজ্ঞাত",
  },
  {
    quote: "``নিজেকে বদলাও, পৃথিবী বদলাতে শুরু করবে।",
    author: "মহাত্মা গান্ধী",
  },
  {
    quote: "``মানুষ সবকিছু অর্জন করতে পারে। তাদের শুধু মানসিকতা প্রয়োজন।",
    author: "তানজিম",
  },
];
...
function getRandomQuote() {
  const randomIndex = Math.floor(
    Math.random() * banglaMotivationalQuotes.length
  );
...
for (let i = 1; i <= chp1Topics.length; i++) {
  ...
  pdf.setAttribute("href", `pdf/topic${i}.pdf`);
  pdf.setAttribute("target", "_blank"); 
  pdf.setAttribute("type", "application/pdf"); 
  pdf.innerText = "Class Note"; 
